import type { ArcjetEmailRule, ArcjetBotRule, ArcjetFilterRule, ArcjetRule, ArcjetMode, ArcjetTokenBucketRateLimitRule, ArcjetFixedWindowRateLimitRule, ArcjetSlidingWindowRateLimitRule, ArcjetShieldRule, ArcjetLogger, ArcjetSensitiveInfoRule, ArcjetWellKnownBot, ArcjetBotCategory, ArcjetEmailType, ArcjetSensitiveInfoType } from "@arcjet/protocol";
...
type PropsForCharacteristic<T> = IsStringLiteral<T> extends true ? T extends "ip.src" | "http.host" | "http.method" | "http.request.uri.path" | `http.request.headers["${string}"]` | `http.request.cookie["${string}"]` | `http.request.uri.args["${string}"]` ? {} : T extends string ? Record<T, boolean | number | string> : never : {};
/**
 ...
 * @link https://docs.arcjet.com/rate-limiting/reference
 */
export declare function fixedWindow<const Characteristics extends readonly string[] = []>(options: FixedWindowRateLimitOptions<Characteristics>): [
    ArcjetFixedWindowRateLimitRule<Simplify<CharacteristicProps<Characteristics>>>
];
/**
 ...
 * @link https://docs.arcjet.com/rate-limiting/reference
 */
export declare function slidingWindow<const Characteristics extends readonly string[] = []>(options: SlidingWindowRateLimitOptions<Characteristics>): [
    ArcjetSlidingWindowRateLimitRule<Simplify<CharacteristicProps<Characteristics>>>
];
/**
...
export declare function protectSignup<const Characteristics extends string[] = []>(options: ProtectSignupOptions<Characteristics>): [
    rateLimit: ArcjetSlidingWindowRateLimitRule<Simplify<CharacteristicProps<Characteristics>>>,
    bot: ArcjetBotRule<{}>,
